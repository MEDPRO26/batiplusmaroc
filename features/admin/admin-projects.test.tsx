...
vi.mock("convex/react", () => ({ useQuery: () => convex.queryResults.shift(), useMutation: () => vi.fn() }));
...
describe("admin projects interface", () => {
  beforeEach(() => { convex.queryResults = [[]]; });
  ...
  test("renders safe project details, history, and pending review actions", () => {
    convex.queryResults = [{
      ...
      actor: { userId: "client-1", displayName: "Samir Client", type: "client" },
      company: null,
      quoteId: null,
      conversationId: null,
      dealId: null,
