...
/** Logged-out visitor navigation — preserves the existing public header design. */
export function PublicNavbar() {
  ...
  const projectCta = getProjectCta(null);
  ...
  return (
    ...
    >
      ...
      >
        <NavbarLogo homeAria={tBrand("homeAria")} inverted={overHero} name={tBrand("name")} />
        <nav
          aria-label={t("main")}
          className="hidden items-center justify-center gap-[clamp(0.75rem,1.6vw,1.75rem)] text-sm lg:flex"
        >
