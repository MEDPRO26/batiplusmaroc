...
export async function ExpertiseGrid() {
  ...
  const tItems = await getTranslations("content.expertise");
  ...
  return (
    <section className="overflow-hidden bg-[#101f33] py-20 md:py-24 lg:py-28" aria-labelledby="expertise-title">
      <header className="mx-auto max-w-[1280px] px-[18px] text-center sm:px-6 lg:px-8">
        <p className="mb-4 text-xs font-bold tracking-[0.16em] text-sky-300 uppercase">{t("eyebrow")}</p>
